...
- [ ] Check existing widgets in `lib/src/shared/widgets/` for reuse opportunities
- [ ] Verify tokens from `lib/src/core/theme/app_tokens.dart`（spacing/radius/sizes/fonts/shadows）
- [ ] Confirm responsive breakpoints via `AppBreakpoints.of(context)`（900/1280 三档）
- [ ] Check theme preset system: `AppTheme.build(preset:, brightness:)`
- [ ] Read font tokens: `AppFontTokens.{display|headline|titleLg|...|mini}`、`AppFontTokens.{bold|semiBold|normal}`
...
| [Component Guidelines](./component-guidelines.md) | Widget 类型选择、结构、设计令牌、响应式、配色、主题预设、字体排版 | 2026-05-25 |
| [UI/UX Guidelines](./uiux-guidelines.md) | 可访问性、交互状态、桌面/移动体验、主题切换、表单反馈 | 2026-05-25 |
| [Directory Structure](./directory-structure.md) | 前端目录组织、文件命名 | 2026-05-25 |
...
| [Quality Guidelines](./quality-guidelines.md) | 禁止/必需模式、测试要求、审查清单 | 2026-05-25 |
